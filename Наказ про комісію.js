...
function onChangeAddApprovers() {
  ...
  if (AddApprovers) {
    ...
    if (arr) {
      EdocsApi.setAttributeValue({ code: "TeacherName2",  value: arr.attributes.find((x) => x.code == "TeachName").value,  text: null,});
      EdocsApi.setAttributeValue({ code: "TeacherId2",   value: arr.attributes.find((x) => x.code == "TeachId").value,  text: null,});
     // EdocsApi.setAttributeValue({ code: "TeacherDep2",  value: arr.attributes.find((x) => x.code == "TeachDiv").value,  text: null,});
      EdocsApi.setAttributeValue({ code: "TeacherPosition2",  value: arr.attributes.find((x) => x.code == "TeachStaf").value,  text: null,});
    }
  } else {
    EdocsApi.setAttributeValue({ code: "TeacherName2",   value: null,  text: null,});
  ...
  //  EdocsApi.setAttributeValue({ code: "TeacherDep2", value: null, text: null });
    EdocsApi.setAttributeValue({ code: "TeacherPosition2",  value: null,  text: null,});
  }
}
...
function onChangeReview() {
  ...
  if (Review) {
    ...
    EdocsApi.setAttributeValue({code: "ProgramEducational3", value: null, text: null });
